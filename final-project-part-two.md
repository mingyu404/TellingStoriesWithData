...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| The problem with the first 2 visualizations (Collision number V.S. Injuries & Fatalities): small and hard to read. | I plan to make it interactive and zoom bigger so that the audience will better understand these data. However, integrating the two charts presents a challenge due to the scale differences — one chart measures in thousands and the other in hundreds on the y-axis. |
